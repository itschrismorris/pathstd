/*
  Documentation: https://www.path.blog/docs/simd_math.html
*/
...
#define I4_STOREU(A, B) _mm_storeu_si128((I4*)(A), B)
...
#define I4_CMP_EQ(A, B) _mm_cmpeq_epi32(A, B)
...
#define I8_STOREU(A, B) _mm256_storeu_si256((I8*)(A), B)
...
#define I8_AND(A, B) _mm256_and_si256(A, B)
...
#define F4_STOREU(A, B) _mm_storeu_ps((F4*)(A), B)
...
#define F8_STOREU(A, B) _mm256_storeu_ps((F8*)(A), B)
